...
get_header( null, [
	...
	'description' => 'Wasp.red dla strzelców sportowych i hobbystów, klubów, instruktorów oraz służb i szkoleń.',
] );
?>
    <section class="on-dark">
        <div class="hero-inner">
            <div class="eyebrow-light">Dla kogo</div>
            <h1 class="h-hero-lg">Ta sama aplikacja, trzy zupełnie różne sposoby użycia</h1>
    ...
    <section class="wr-dla-02">
        <div class="wr-dla-03">
            <div>
                ...
                <h2 class="wr-dla-04">Strzelcy sportowi i hobbyści</h2>
                <p class="p-body p-body--ink wr-dla-05">Przygotowanie do startu to kilkadziesiąt treningów, po których
                    ...
                    przed zawodami wiesz, czy skupienie faktycznie rośnie — i przy jakiej amunicji. A jeśli wyjeżdżasz
                    postrzelać tylko kilka razy w roku, to wystarczy zdjęcie tarczy, żeby po sezonie zobaczyć czarno na
                    białym, że strzelasz lepiej.</p>
        ...
        <div class="wr-dla-08">
            ...
            <div class="wr-dla-09">
                <div class="wr-dla-10">PROFIL 03</div>
                ...
                <p class="p-body on-dark-muted wr-dla-11">Dla części użytkowników „w chmurze” nie jest opcją i nigdy nie
                    będzie. Dlatego rdzeń aplikacji działa bez sieci i bez wysyłania czegokolwiek na serwer —
                    funkcjonalność jest pełna, nie okrojona.</p>
